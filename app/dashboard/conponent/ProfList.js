...
export default function ProfList() {
    ...
    return(
        <div className="flex flex-col gap-4">
            <p>Hey {user.username}, get in touch with the best Therapist in world</p>
            <div className="flex flex-col gap-2 w-[30%] border border-[#80808042] p-3 items-center justify-center">
